...
- User can request special status using the "Request special status" button at the bottom of the page. This will allow users to notify their status as athlete or employee to receive special discounts and offers.
