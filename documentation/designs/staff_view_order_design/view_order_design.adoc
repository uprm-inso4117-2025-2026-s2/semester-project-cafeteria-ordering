...
-To avoid confucion, unread orders have a white dot at the corner, opened orders have a green dot at the corner and finished orders have no dot. 
-Once an order is maked as finished, the user will recieve a notification that their order is ready for pick-up.
