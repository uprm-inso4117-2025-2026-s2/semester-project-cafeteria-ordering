...
*Final product:*
All pages can be viewed in Wireframes/images folder.
...
image::images/Unread_page.png[unread page, width=60%]
--
<<<
[%unbreakable]
--
...
image::images/Opened_page.png[opened_page, width=80%]
--
<<<
[%unbreakable]
--
...
image::images/Finished_page.png[finished_page, width=80%]
...
image::images/Full_order_view_unread.png[full_order_view_unread, width=80%]
...
image::images/Full_order_view_opened.png[full_order_view_opened, width=80%]
