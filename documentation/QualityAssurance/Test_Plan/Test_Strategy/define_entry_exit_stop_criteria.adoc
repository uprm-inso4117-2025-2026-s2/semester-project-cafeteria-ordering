...
| 6 | Regression test suite identified for modified modules | Test case repository / tracking tool
|===
...
| 7 | Regression tests executed for all impacted units | Test runner / CI output | 100% pass for impacted modules
|===
...
| 7 | Regression test suite identified for integrated modules | Test repository / CI tracking
|===
...
| 8 | Regression tests executed for impacted integrations | Test runner / CI output | 100% pass for impacted flows
|===
...
| 7 | Regression test suite identified for all critical workflows and previous defects | Test selection documented
|===
...
| 10 | Regression tests executed successfully | Test results / CI output | 100% pass for impacted areas
|===
...
| 8 | Regression test cases covering previous defects and core workflows prepared | Test case repository / test plan
|===
...
| 8 | Regression tests executed successfully | Test results / UAT sign-off | 100% pass for impacted areas
|===
...
== 10. Regression Testing Guidelines

Regression Testing ensures that existing functionality continues to work
after changes are introduced. Regression tests span all testing levels and
are triggered when:

* New features are added
* Existing functionality is modified
* Bug fixes are applied
* Business rules or workflows are updated

Regression coverage MUST include:

* Critical user workflows (login, ordering, payment)
* Previously fixed defects
* Core integrations between modules
* High-risk areas identified from past releases

Regression tests MUST be executed in CI/CD pipelines wherever feasible,
and results documented per testing phase metrics.