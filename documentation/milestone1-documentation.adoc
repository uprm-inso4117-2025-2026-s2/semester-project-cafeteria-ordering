...
* employee: person who works on the cafeteria, takes order from customer.

* student: person who is a student in from the university campus and places and order on the cafeteria.

* customer: person who places order on the cafeteria.
