...
Description
Load testing for customer ordering workflow. T
hree scenarios used in order to see how the workflow can handle a heavy workload.


Preconditions
* Connection to database is successfull
* Ordering screen is implemented
* Testing program accessible
*/
...
Expected Results
- The program will confirm each order.
- The program's latency and response time remain strong even while having workload

Notes

*This is attached to a LTT (#570), see /LectureTopicTasks/loadTesting-CutomerOrdering

Author: Lorenzo Perez Torres - @Lorenzo-PT
Date Created: 2026-16-05
